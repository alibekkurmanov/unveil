...
<div class="humberger__menu__wrapper">
    ...
    <div class="humberger__menu__contact">
        <ul>
            <li><i class="fa fa-envelope"></i> unveil@gmail.com </li>
            <li>Работа со спецификациями строительных проектов</li>
        </ul>
    </div>
</div>
                ...
                <div class="col-lg-6">
                    <div class="header__top__right">
                        ...
                        if ($_SESSION['role'] == 'admin') {
                            ...
                            $adminPanelLink = './seller';
                        } 
                        if (isset($adminPanelLink)): ?>
                            <div class="admin-panel">
                                <a href="<?php echo $adminPanelLink; ?>">Admin Panel</a>
                            </div>
                        <?php endif; ?>
